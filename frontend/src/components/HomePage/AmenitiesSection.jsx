        ...
        <div className="w-full max-w-md mx-auto space-y-12">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-800">
                Convenient in-house amenities, staff and services elevate the
                living experience.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-800">
                The building's personalized services and carefully curated
                amenities.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-800">
                Nothing works better to help you work out like links that in a
                quick session.
              </p>
            </div>
          </motion.div>
